...
@foreach($sliders as $slider)
    <div class="slider-item"
         style="background-image: url({{asset('slider_images/'.$slider->slider_image)}});">
...
<div class="row">
    @foreach($products as $product)
        <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
                <a href="{{url('show-product',$product->id)}}" class="img-prod"><img class="img-fluid"
                src="{{asset('images_products/'.$product->product_image)}}"
                alt="Colorlib Template">
                    <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    <h3><a href="{{url('show-product').'/'.encrypt($product->id)}}">{{$product->product_name}}</a></h3>
                    <p class="price"><a href="{{url('show-product'.'/'.encrypt($product->id))}}">${{$product->product_price}}</a>
                    </p>
                </div>
            </div>
        </div>
